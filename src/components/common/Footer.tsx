...
export const Footer = () => {
  return (
    <footer className="bg-gray-100 pt-16 pb-8">
      <div className="container mx-auto px-4 md:pl-20">
        <div className="bg-black text-white p-8 rounded-2xl mb-16">
            ...
            <div className="w-full md:w-auto">
              <div className="flex flex-col gap-4">
                <input
                  ...
                  className="w-full md:w-80 px-6 py-4 bg-white rounded-full text-black"
                />
                <button className="bg-white text-black px-8 py-4 rounded-full font-semibold whitespace-nowrap">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <Link href="#" className="bg-black text-white p-2 rounded-full">
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
                  viewBox="0 0 24 24"
        ...
        <div className="mt-16 pt-8 border-t border-gray-300 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4">
            <Image src="/Badge.png" alt="Visa" width={80} height={40} />
            <Image
              src="/Badge (1).png"
              alt="Mastercard"
              width={80}
              height={40}
            />
            <Image src="/Badge (2).png" alt="PayPal" width={80} height={40} />
            <Image
              src="/Badge (3).png"
              alt="Apple Pay"
              width={80}
